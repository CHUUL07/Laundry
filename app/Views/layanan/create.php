...
<div class="card" style="max-width: 720px;">
    <div class="card-body">
        <form method="POST" action="/layanan/store" novalidate>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select
                        ...
                        required>
                        <option value="kg" <?= ($old['satuan_harga'] ?? 'kg') === 'kg' ? 'selected' : '' ?>>Per Kg</option>
                        <option value="item" <?= ($old['satuan_harga'] ?? '') === 'item' ? 'selected' : '' ?>>Per Item</option>
                        <option value="paket" <?= ($old['satuan_harga'] ?? '') === 'paket' ? 'selected' : '' ?>>Per Paket</option>
                    </select>
