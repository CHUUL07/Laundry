<div class="page-header">
    ...
    <p class="page-subtitle">Ubah data pelanggan yang sudah terdaftar di sistem.</p>
</div>

<div class="card" style="max-width: 680px;">
    <div class="card-body">
        <form method="POST" action="/pelanggan/update/<?= $pelanggan['id'] ?>" novalidate>
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    value="<?= htmlspecialchars($old['nama_pelanggan'] ?? $pelanggan['nama_pelanggan']) ?>"
                    maxlength="100"
                    required>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="<?= htmlspecialchars($old['no_telp'] ?? $pelanggan['no_telp']) ?>"
                        maxlength="15"
                        required>
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="<?= htmlspecialchars($old['email'] ?? $pelanggan['email'] ?? '') ?>"
                        maxlength="100">
            ...
            <div class="form-group">
                ...
                <textarea
                    ...
                    rows="3"><?= htmlspecialchars($old['alamat'] ?? $pelanggan['alamat'] ?? '') ?></textarea>
